  ...
  <body>
    <div class="wrapper">
        ...
        <table class="header-table">
          <tr>
            ...
            <td class="company-info">
              <h1><?php echo e($company['name'] ?? 'Fortress Empreendimentos'); ?></h1>
      ...
      <p class="muted" style="text-align:center; margin-top:-6px; margin-bottom:12px;">
        Período de <?php echo e($periodFrom); ?> a <?php echo e($periodTo); ?> • Conta: <?php echo e($accountLabel); ?>

      </p>

      <div class="filters-card">
        <div class="filters-grid">
          <div class="filters-item"><strong>Tipo</strong> <?php echo e($typeLabel); ?></div>
          <div class="filters-item"><strong>Status</strong> <?php echo e($statusLabel); ?></div>
          <div class="filters-item"><strong>Análise por</strong> <?php echo e($basisLabel); ?></div>
          <div class="filters-item"><strong>Fornecedor/Cliente</strong> <?php echo e($personLabel ?? 'Todos'); ?></div>
          <div class="filters-item"><strong>Imóvel</strong> <?php echo e($propertyLabel ?? 'Todos'); ?></div>
          <div class="filters-item"><strong>Centro de custo</strong> <?php echo e($costCenterLabel ?? 'Todos'); ?></div>
          <div class="filters-item"><strong>Ordenação</strong> <?php echo e($orderByLabel); ?> • <?php echo e($orderDirection); ?></div>
          <div class="filters-item"><strong>Descrição contém</strong> <?php echo e($descriptionFilter ?: 'Qualquer'); ?></div>
          <div class="filters-item"><strong>Total de lançamentos</strong> <?php echo e($totalCount); ?></div>
        </div>
      </div>
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <tr>
              ...
              <td class="col-type">
                <?php echo e(mb_strtoupper($row['type_label'] ?? '-', 'UTF-8')); ?>

              </td>
              <td class="col-person">
                <?php echo e($row['person'] ? mb_strtoupper($row['person'], 'UTF-8') : '—'); ?>

              </td>
              <td class="col-description">
                <strong><?php echo e(mb_strtoupper($row['description'] ?? 'Sem descrição', 'UTF-8')); ?></strong>
                <?php if(!empty($row['notes'])): ?>
                  <div class="text-muted"><?php echo e($row['notes']); ?></div>
                <?php endif; ?>
              </td>
              <td class="col-details">
                <?php if(!empty($row['property'])): ?>
                  <div><?php echo e(mb_strtoupper($row['property'], 'UTF-8')); ?></div>
                <?php endif; ?>
                <?php if(!empty($row['cost_center'])): ?>
                  <div class="text-muted"><?php echo e($row['cost_center']); ?></div>
                <?php endif; ?>
                <?php if(empty($row['property']) && empty($row['cost_center'])): ?>
                  —
                <?php endif; ?>
              </td>
              <td class="col-account">
                <?php if(!empty($row['account'])): ?>
                  <div><?php echo e(mb_strtoupper($row['account'], 'UTF-8')); ?></div>
                <?php endif; ?>
                <?php if(!empty($row['document'])): ?>
                  <div class="text-muted">Doc: <?php echo e($row['document']); ?></div>
                <?php endif; ?>
                <?php if(empty($row['account']) && empty($row['document'])): ?>
                  —
                <?php endif; ?>
              </td>
              <td class="col-status">
              ...
              <td class="col-value" style="color: <?php echo e($signed < 0 ? '#b91c1c' : '#166534'); ?>; font-weight: 600;">
                <?php echo e($formattedValue); ?>
      ...
      <div class="summary-grid" style="margin-top: 16px;">
        <div class="summary-card">
          ...
          <div class="summary-value">R$ <?php echo e(number_format($inflow, 2, ',', '.')); ?></div>
        </div>
        <div class="summary-card">
          <div class="summary-label">Total de saídas</div>
          <div class="summary-value">R$ <?php echo e(number_format($outflow, 2, ',', '.')); ?></div>
        </div>
        <div class="summary-card">
          <div class="summary-label">Resultado líquido</div>
          <div class="summary-value" style="color: <?php echo e($net >= 0 ? '#166534' : '#b91c1c'); ?>;">
            R$ <?php echo e(number_format($net, 2, ',', '.')); ?>
      ...
      <div class="footer">
        Relatório gerado por <?php echo e($filters['generated_by'] ?? 'Sistema'); ?> em <?php echo e(now()->format('d/m/Y H:i')); ?>.
      </div>
    </div>
  </body>
</html>
<?php /**PATH /home/vinidyas/Projetos/fortress-laravel/resources/views/pdf/general-analytic-report.blade.php ENDPATH**/ ?>