...
<html lang="pt-BR">
  <head>
    <meta charset="utf-8">
    <title>Recibo da Fatura #<?php echo e($fatura->id); ?> - <?php echo e($company['name']); ?></title>
    <style>
  ...
  <body>
    ...
    <div class="receipt-wrapper">
      <header>
        <?php if($logoBase64): ?>
          <img src="<?php echo e($logoBase64); ?>" alt="Logo <?php echo e($company['name']); ?>" class="logo">
        <?php endif; ?>
        <div class="company">
      ...
      <section class="title-section">
        <h2>Recibo da Fatura nº <?php echo e($fatura->id); ?></h2>
        <p>Emitido em <?php echo e(optional($fatura->created_at)->timezone('America/Sao_Paulo')->format('d/m/Y H:i')); ?></p>
      </section>

      <section class="meta">
        <div class="meta-card">
          <h3>Cliente</h3>
          <p><?php echo e($fatura->contrato?->locatario?->nome_razao_social ?? '---'); ?></p>
          <p style="font-weight:400; color:#64748b;">Contrato <?php echo e($fatura->contrato?->codigo_contrato ?? '---'); ?></p>
        </div>
        <div class="meta-card">
          <h3>Imóvel</h3>
          <p><?php echo e($fatura->contrato?->imovel?->codigo ?? '---'); ?></p>
          <p style="font-weight:400; color:#64748b;"><?php echo e($fatura->contrato?->imovel?->cidade ?? ''); ?></p>
        </div>
        <div class="meta-card">
          <h3>Competência</h3>
          <p><?php echo e(optional($fatura->competencia)->format('m/Y')); ?></p>
        </div>
        <div class="meta-card">
          <h3>Vencimento</h3>
          <p><?php echo e(optional($fatura->vencimento)->format('d/m/Y')); ?></p>
        </div>
      </section>
      ...
      <section style="padding: 0 40px 24px;">
        <table>
          ...
          <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $fatura->itens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr>
                <td><?php echo e($item->categoria); ?></td>
                <td><?php echo e($item->descricao ?? '---'); ?></td>
                <td style="text-align:right;"><?php echo e(number_format((float) $item->quantidade, 0, ',', '.')); ?></td>
                <td style="text-align:right;"><?php echo e('R$ ' . number_format((float) $item->valor_unitario, 2, ',', '.')); ?></td>
                <td style="text-align:right;"><?php echo e('R$ ' . number_format((float) $item->valor_total, 2, ',', '.')); ?></td>
              </tr>
          ...
          <tfoot>
            <tr>
              ...
              <td style="text-align:right;"><?php echo e('R$ ' . number_format((float) $fatura->valor_total, 2, ',', '.')); ?></td>
            </tr>
          </tfoot>
        </table>
      </section>
      ...
      <div class="summary">
        <div class="thanks">
          ...
          <?php echo e($fatura->contrato?->locatario?->nome_razao_social ?? '---'); ?><br>
          <strong>Descrição:</strong> Pagamento referente à fatura nº <?php echo e($fatura->id); ?> do contrato <?php echo e($fatura->contrato?->codigo_contrato ?? '---'); ?>.
        </div>
        <div class="total"><?php echo e('R$ ' . number_format((float) ($fatura->valor_pago ?? $fatura->valor_total), 2, ',', '.')); ?></div>
      </div>
      ...
      <section style="padding: 0 40px 24px; display:grid; gap:18px;">
        ...
        <div style="font-size:13px; color:#475569;">
          <strong>Forma de pagamento:</strong> <?php echo e($formaPagamento ?? 'Não informado'); ?><br>
          <strong>Status:</strong> <?php echo e($fatura->status); ?><br>
          <strong>Pago em:</strong> <?php echo e(optional($fatura->pago_em)->format('d/m/Y') ?? '—'); ?>

        </div>
        <?php if($fatura->observacoes): ?>
          <div style="font-size:13px; color:#475569;">
            <strong>Observações:</strong><br>
            <?php echo e($fatura->observacoes); ?>
      ...
      <div class="footer">
        ...
        <p style="margin-top:24px;">Este recibo foi gerado automaticamente por <?php echo e($company['name']); ?>. Para dúvidas ou ajustes, entre em contato conosco.</p>
      </div>
    </div>
  </body>
</html>
<?php /**PATH /home/vinidyas/projetos/fortress-laravel/resources/views/receipts/fatura.blade.php ENDPATH**/ ?>