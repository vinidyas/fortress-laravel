...
<html lang="pt-BR">
  <head>
    <meta charset="utf-8">
    <title><?php echo e($detailedReportTitle); ?></title>
    <style>
      @page {
      ...
      :root {
        color-scheme: light;
        --column-date-width: <?php echo e($dateColumnWidth); ?>%;
        --column-due-width: <?php echo e($dueColumnWidth); ?>%;
        --column-status-width: <?php echo e($statusColumnWidth); ?>%;
        --column-value-width: <?php echo e($valueColumnWidth); ?>%;
        --column-description-width: <?php echo e($descriptionColumnWidth); ?>%;
        --column-supplier-width: <?php echo e($supplierColumnWidth); ?>%;
        --column-property-width: <?php echo e($propertyColumnWidth); ?>%;
      }
      body {
  ...
  <body>
    <div class="wrapper">
        ...
        <table class="header-table">
          <tr>
            ...
            <td class="company-info">
              ...
              <p><?php echo e($detailedReportTitle); ?></p>
              <p class="muted">
      ...
      <?php else: ?>
        <p class="muted" style="margin-top: -8px; margin-bottom: 12px; text-align: center;">
          Período de <?php echo e($periodFrom); ?> a <?php echo e($periodTo); ?>
              ...
              <?php if($loop->last): ?>
                <tr>
                  <td colspan="6" class="text-right" style="padding-right: 12px; font-weight:600;">
                    <?php echo e($isRevenueReport ? 'TOTAL DE RECEITAS' : 'TOTAL DAS DESPESAS'); ?>

                  </td>
                  <td class="column-value text-right" style="font-weight:700;">
                    R$
                    <?php echo e(number_format($isRevenueReport ? $totalRevenue : $totalExpenses, 2, ',', '.')); ?>
