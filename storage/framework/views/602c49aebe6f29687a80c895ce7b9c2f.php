...
<html lang="pt-BR">
  <head>
    <meta charset="utf-8">
    <title>Fatura #<?php echo e($fatura->id); ?> - <?php echo e($company['name']); ?></title>
    <style>
  ...
  <body>
    ...
    <div class="invoice-wrapper">
      <header>
        ...
        <?php endif; ?>
        <div class="branding">
          <h1><?php echo e(strtoupper($company['name'])); ?></h1>
      ...
      <div class="invoice-info">
        <div>
          <h2 class="invoice-title">Fatura #<?php echo e($fatura->id); ?></h2>
          <p class="invoice-meta">Emitida em <?php echo e(optional($fatura->created_at)->timezone('America/Sao_Paulo')->format('d/m/Y H:i')); ?></p>
        </div>
        <div class="invoice-meta" style="text-align:right;">
          <p><strong>Competência:</strong> <?php echo e(optional($fatura->competencia)->format('m/Y')); ?></p>
          <p><strong>Vencimento:</strong> <?php echo e(optional($fatura->vencimento)->format('d/m/Y')); ?></p>
        </div>
      </div>
      ...
      <section class="client-supplier">
        <div class="panel">
          <h3>Destinatário</h3>
          <p><strong><?php echo e($fatura->contrato?->locatario?->nome_razao_social ?? '---'); ?></strong></p>
          <p><?php echo e($fatura->contrato?->locatario?->documento ?? ''); ?></p>
          <p><?php echo e($fatura->contrato?->locatario?->endereco ?? 'Endereço não informado'); ?></p>
        </div>
        <div class="panel">
          <h3>Responsável</h3>
          <p><strong><?php echo e($fatura->contrato?->locador?->nome_razao_social ?? $company['name']); ?></strong></p>
          <p><?php echo e($fatura->contrato?->locador?->telefone ?: 'Telefone não informado'); ?></p>
          <?php
            ...
            $locadorEmails = collect($locadorEmails)
              ...
              ->filter();
          ?>
          <?php if($locadorEmails->isNotEmpty()): ?>
            <?php $__currentLoopData = $locadorEmails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $email): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="panel">
          <h3>Condições</h3>
          <p><strong>Forma de cobrança:</strong> <?php echo e($formaPagamento ?? 'Definir com o gestor'); ?></p>
          <p><strong>Status:</strong> <?php echo e($fatura->status); ?></p>
        </div>
      </section>
      ...
      <section class="payment-block">
        <div class="highlight">
          ...
          <span class="amount"><?php echo e('R$ ' . number_format((float) $fatura->valor_total, 2, ',', '.')); ?></span>
        </div>
...
<?php /**PATH /home/vinidyas/projetos/fortress-laravel/resources/views/receipts/fatura-cobranca.blade.php ENDPATH**/ ?>