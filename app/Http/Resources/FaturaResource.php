...
class FaturaResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'boletos' => FaturaBoletoResource::collection($this->whenLoaded('boletos')),
            'boleto_atual' => $this->whenLoaded('boletos', function () {
                $boleto = $this->boletos->first();

                return $boleto ? new FaturaBoletoResource($boleto) : null;
            }),
