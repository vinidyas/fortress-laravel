            ...
            <section class="rounded-xl border border-slate-800 bg-slate-950/60 p-4">
              ...
              <div class="mt-4 grid gap-3 md:grid-cols-4">
                <div class="flex flex-col gap-1">
                  ...
                  <input v-model="auditFilters.dateFrom" type="date" class="rounded-lg border border-slate-700 bg-slate-900/60 px-3 py-2 text-xs text-slate-200 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500/40" />
                </div>
                <div class="flex flex-col gap-1">
                  <label class="text-xs font-semibold uppercase tracking-wide text-slate-400">Até</label>
                  <input v-model="auditFilters.dateTo" type="date" class="rounded-lg border border-slate-700 bg-slate-900/60 px-3 py-2 text-xs text-slate-200 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500/40" />
                </div>
