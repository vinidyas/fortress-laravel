...
<template>
    <section class="overflow-hidden rounded-2xl border border-slate-800 bg-slate-900/70">
        <header class="flex flex-wrap items-center justify-between gap-3 border-b border-slate-800 px-4 py-3 text-sm text-slate-300">
        ...
        <footer v-if="props.links.length > 1" class="flex flex-wrap items-center justify-center gap-2 border-t border-slate-800 px-4 py-3">
            <button
