    ...
    <AuthenticatedLayout title="Dashboard">
        <div class="space-y-10 text-slate-100">
            <section class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                <article class="rounded-2xl border border-slate-800 bg-slate-900/80 p-6 shadow-xl shadow-black/40">
            ...
            <section class="grid gap-6 xl:grid-cols-2">
                <div class="rounded-2xl border border-slate-800 bg-slate-900/80 p-6 shadow-xl shadow-black/40">
                    ...
                    <div v-if="!expiringContracts.length" class="mt-8 rounded-xl border border-dashed border-slate-800 bg-slate-900/40 px-4 py-12 text-center text-sm text-slate-400">
                            ...
                            <tbody class="divide-y divide-slate-800 bg-slate-950/40 text-slate-200">
                                ...
                                <tr v-for="invoice in openInvoices" :key="invoice.id">
                                    <td class="px-4 py-4">
                                        ...
                                        <p class="text-xs text-slate-400">Compet?ncia {{ formatDate(invoice.competencia) }}</p>
                                    </td>
            ...
            <section class="rounded-2xl border border-slate-800 bg-slate-900/80 p-6 shadow-xl shadow-black/40">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-slate-400">?ltimas 5 entradas</p>
                    </div>
                </div>
